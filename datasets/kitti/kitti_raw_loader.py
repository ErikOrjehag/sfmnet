...
class KittiRawLoader(object):
    ...
    def load_image(self, scene_data, tgt_idx):
        ...
        img = skimage.transform.resize(img, (self.img_height, self.img_width))
    ...
    def generate_depth_map(self, scene_data, tgt_idx):
        ...
        dense = self.lin_interp((self.img_height, self.img_width), velo_pts_im)
